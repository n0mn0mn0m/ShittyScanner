...
class Scanner:
    def __init__(self, fileName):
        ...
        self.signatures = [
            ...
            {'type' : '0', 'name' : 'MPEG2', 'header' : b'\x00\x00\x01\xBA', 'trailer' : b'\x00\x00\x01\xB9', 'extension' : '.mpg'},
            {'type' : '0', 'name' : 'MPEG', 'header' : b'\x00\x00\x01', 'trailer' : b'\x00\x00\x01\xB7', 'extension' : '.mpg'}
        ]
